;(function (window, document) {
    ...
    Imager.prototype.changeDivsToEmptyImages = function(disableLazyLoad){
        var self = this;
        if (typeof disableLazyLoad == "undefined") {
            disableLazyLoad = false;
        }

        applyEach(this.divs, function(element, i){
            if (self.lazyload) {
                if (!self.isThisElementOnScreen(element) || (!disableLazyLoad && element.clientWidth == 0)) {
